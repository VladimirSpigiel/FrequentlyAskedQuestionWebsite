...
/* AllotoolsFaqBundle:Admin/User:modifier.html.twig */
class __TwigTemplate_336b81b9411b27b360aef62b48ccbade0fb397d494cc2a79b19314ebef924524 extends Twig_Template
{
...
";
    ...
    <div class=\"container\">
        ...
        echo "
                    ";
        // line 27
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "username"), 'widget', array("attr" => array("class" => "form-control", "placeholder" => "Nom de l'utilisateur")));
        // line 28
        echo "
                </div>
                <div class=\"form-group\">
        ...
        echo "
                    ";
        // line 32
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "email"), 'label', array("label" => "E-Mail"));
        echo "
                    ";
        // line 33
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "email"), 'widget', array("attr" => array("class" => "form-control", "placeholder" => "adresse@mail.com")));
        // line 34
        echo "
                </div>
                <div class=\"form-group\">
        ...
        echo "
                    ";
        // line 38
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "profil"), 'label');
        echo "
                    ";
        // line 39
        ...
        echo "
                <button type=\"submit\" class=\"btn btn-success\"><span class=\"glyphicon glyphicon-ok\"></span> Modifier
                </button>
            </form>
        </div>
    </div>
...
";
    ...
    {
        return "AllotoolsFaqBundle:Admin/User:modifier.html.twig";
    }
