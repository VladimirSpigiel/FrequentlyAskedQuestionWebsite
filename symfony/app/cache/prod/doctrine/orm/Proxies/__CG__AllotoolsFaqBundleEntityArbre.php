 ...
 */
class Arbre extends \Allotools\FaqBundle\Entity\Arbre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nb_vue', 'libelle', 'categorie', 'actif');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Arbre $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setCategorie(\Allotools\FaqBundle\Entity\Categorie $categorie = NULL)
    {
    ...
    public function getNbVue()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNbVue', array());

        return parent::getNbVue();
    }
    ...
    public function setNbVue($nbVue)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNbVue', array($nbVue));

        return parent::setNbVue($nbVue);
    }
