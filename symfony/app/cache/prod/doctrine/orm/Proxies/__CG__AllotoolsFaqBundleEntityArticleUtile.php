 ...
 */
class ArticleUtile extends \Allotools\FaqBundle\Entity\ArticleUtile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'utile', 'compteur', 'date', 'article');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ArticleUtile $proxy) {
    ...
    public function setUtile($utile)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUtile', array($utile));

        return parent::setUtile($utile);
    }
    ...
    public function getUtile()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUtile', array());

        return parent::getUtile();
    }
