...
";
    ...
    <div class=\"container\">
        ...
        echo "
                    ";
        // line 24
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "categories"), 'label', array("label" => "Catégories"));
        echo "
                    ";
        // line 25
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "categories"), 'widget', array("attr" => array("class" => "form-control")));
        echo "
                </div>
