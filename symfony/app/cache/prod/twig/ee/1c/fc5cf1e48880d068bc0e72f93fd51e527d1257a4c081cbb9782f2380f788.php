...
";
    ...
    <table class=\"table table-bordered table-striped table-hover text-left\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["question"]) {
            ...
            // line 26
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("allotools_faq_manage_questions_edit", array("id" => $this->getAttribute((isset($context["question"]) ? $context["question"] : null), "id"))), "html", null, true);
            ...
            echo "                 ";
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["fils"]) ? $context["fils"] : null));
            foreach ($context['_seq'] as $context["_key"] => $context["filsAct"]) {
                // line 29
                echo "                       ";
                if (($this->getAttribute((isset($context["filsAct"]) ? $context["filsAct"] : null), "question") != null)) {
                    // line 30
                    echo "                           ";
                    if (($this->getAttribute($this->getAttribute((isset($context["filsAct"]) ? $context["filsAct"] : null), "question"), "id") == $this->getAttribute((isset($context["question"]) ? $context["question"] : null), "id"))) {
                        // line 31
                        echo "                               ";
                        $context["trouve"] = 1;
                        // line 32
            ...
            echo "
                ...
                <td class=\"text-center\">
                            ";
            // line 38
            if (((isset($context["trouve"]) ? $context["trouve"] : null) == 0)) {
                // line 39
                echo "                                <a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("allotools_faq_manage_questions_delete", array("id" => $this->getAttribute((isset($context["question"]) ? $context["question"] : null), "id"))), "html", null, true);
                echo "\"
