...
(function($) {
    ...
    function buildNode($node, $appendTo, level, opts) {
        ...
        if(!$nodeDiv.hasClass("temp")){
                ...
                $nodeDiv.find(".opciones:eq(0)").append("<span class='edit glyphicon glyphicon-pencil text-warning pull-left' href='#fancy_edit'></span>");
            if($nodeDiv.hasClass("child")){
                $nodeDiv.find(".opciones:eq(0)").append("<span class='del glyphicon glyphicon-minus-sign text-danger pull-right'></span>");
            }
        }else{
            $nodeDiv.find(".opciones:eq(0)").append("<span class='add glyphicon glyphicon-plus-sign text-success pull-left' href='#fancy'></span>" +
                "<span class='del glyphicon glyphicon-minus-sign text-danger pull-right'></span>");
        }
